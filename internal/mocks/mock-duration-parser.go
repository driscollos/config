...
//
//	mockgen -destination=../../mocks/mock-duration-parser.go -package=mocks . DurationParser
//
...
func (m *MockDurationParser) Parse(duration string) (time.Duration, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Parse", duration)
...
func (mr *MockDurationParserMockRecorder) Parse(duration any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Parse", reflect.TypeOf((*MockDurationParser)(nil).Parse), duration)
}
